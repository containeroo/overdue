...
| `--email.<name>.subject-template`          | `OVERDUE__EMAIL_<NAME>_SUBJECT_TEMPLATE`          | `{{ .Title }}`                               | Template for alerting email subject.                  |
| `--email.<name>.resolved-subject-template` | `OVERDUE__EMAIL_<NAME>_RESOLVED_SUBJECT_TEMPLATE` | `{{ .Title }}`                               | Template for resolved email subject.                  |
